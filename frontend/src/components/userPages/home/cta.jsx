...
const CTA = () => {
  return (
    <section className="py-8 bg-[#FAF7F2] overflow-hidden font-['Inter'] relative">
      {/* Background Glow */}
      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        ...
        >
          ...
          <div className="max-w-5xl mx-auto text-center relative z-10">
            ...
            <motion.p
              variants={fadeUp}
              className="font-['Playfair_Display'] text-white/75 text-lg md:text-xl mt-8 leading-8 max-w-3xl mx-auto"
            >
          ...
          >
            <button className="font-['Playfair_Display'] group bg-[#0F766E] hover:bg-white hover:text-[#0F172A] text-white px-8 py-4 rounded-full font-semibold flex items-center gap-3 transition-all duration-300">
              Request Consultation
              <FaArrowRight className="group-hover:translate-x-1 transition" />
            </button>

            <button className="font-['Playfair_Display'] border border-white/20 hover:bg-white hover:text-[#0F172A] text-white px-8 py-4 rounded-full font-semibold transition-all duration-300">
              Get a Quote
            </button>
          </motion.div>
          ...
          >
            <p className="font-['Playfair_Display'] text-white/60 text-sm md:text-base max-w-4xl mx-auto leading-7">
              Helping Indian manufacturers, exporters, MSMEs, distributors, and
              international buyers navigate sourcing, export documentation,
